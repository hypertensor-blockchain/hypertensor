...
//! Autogenerated weights for `pallet_subnet_democracy`
//!
...
// --pallet=pallet_subnet_democracy
// --extrinsic=*
// --steps=5
// --repeat=2
// --output=pallets/subnet-democracy/src/weights.rs
// --template
...
/// Weight functions needed for `pallet_subnet_democracy`.
...
/// Weights for `pallet_subnet_democracy` using the Substrate node and recommended hardware.
