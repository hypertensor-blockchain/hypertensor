...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn form_consensus_no_consensus_weight_test() -> Weight {
        ...
        Weight::from_parts(7_628_000, 1638).saturating_add(T::DbWeight::get().reads(1_u64))
    }
}
...
impl WeightInfo for () {
    ...
    fn form_consensus_no_consensus_weight_test() -> Weight {
        ...
        //  Estimated: `1638`
        // Minimum execution time: 7_068_000 picoseconds.
        Weight::from_parts(7_628_000, 1638).saturating_add(RocksDbWeight::get().reads(1_u64))
    }
}
