...
impl<T: Config> Pallet<T> {
  ...
  */
  pub fn get_model_initialization_cost(block: u64) -> u128 {
    ...
    let min_required_consensus_inclusion_epochs: u64 = MinRequiredPeerConsensusInclusionEpochs::<T>::get();
  ...
  pub fn can_remove_or_update_model_peer(block: u64, interval: u64) -> bool {
    ...
    let remove_peer_block_percentage_of_epoch: u128 = RemoveModelPeerEpochPercentage::<T>::get();
