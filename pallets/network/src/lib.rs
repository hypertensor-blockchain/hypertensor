...
pub mod pallet {
    ...
    pub enum Event<T: Config> {
        ...
        DishonestModelPeerProposed {
            model_id: u32,
            account_id: T::AccountId,
            block: u64,
        },
        DishonestModelPeerVote {
            model_id: u32,
            account_id: T::AccountId,
            voter_account_id: T::AccountId,
            block: u64,
        },
        DishonestAccountRemoved {
            model_id: u32,
            account_id: T::AccountId,
            block: u64,
        },
    ...
    #[pallet::type_value]
    pub fn DefaultModelPeerConsensusResults<
        T: Config
    ...
    #[pallet::type_value]
    pub fn DefaultModelPeerDishonestyVote<
        T: Config
    ...
    #[pallet::type_value]
    pub fn DefaultConsensusSubmissionData<
        T: Config
    ...
    #[pallet::storage]
    pub type ModelPerPeerInitCost<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultModelPerPeerInitCost<T>
    >;
    ...
    #[pallet::storage]
    pub type RemoveModelPeerEpochPercentage<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultRemoveModelPeerEpochPercentage<T>
    >;
    ...
    #[pallet::storage]
    pub type ModelPeersInitializationEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultModelPeersInitializationEpochs<T>
    >;
    ...
    pub type AccountModels<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        Vec<u32>,
    ...
    pub type TotalModelPeers<T: Config> = StorageMap<_, Blake2_128Concat, u32, u32, ValueQuery>;
    ...
    #[pallet::storage]
    pub type MinRequiredUnstakeEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredUnstakeEpochs<T>
    >;
    ...
    pub type TotalModelStake<T: Config> = StorageMap<_, Blake2_128Concat, u32, u128, ValueQuery>;
    ...
    pub type TotalAccountStake<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        T::AccountId,
        u128,
    ...
    #[pallet::storage]
    pub type MaxStakeBalance<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultMaxStakeBalance<T>
    >;

    // Minimum required model peer stake balance per model
    #[pallet::storage]
    pub type MinStakeBalance<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultMinStakeBalance<T>
    >;
    ...
    #[pallet::storage]
    pub type OptimalPeersPerModel<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultOptimalPeersPerModel<T>
    >;

    #[pallet::storage]
    pub type InflationUpperBound<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultInflationUpperBound<T>
    >;

    #[pallet::storage]
    pub type InflationLowerBound<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultInflationLowerBound<T>
    >;
    ...
    #[pallet::storage]
    pub type MinRequiredDelegateUnstakeEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredDelegateUnstakeEpochs<T>
    >;

    // Total stake sum of all peers in specified model
    #[pallet::storage] // model_uid --> peer_data
    pub type TotalModelDelegateStakeShares<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        u32,
        u128,
    ...
    // Total stake sum of all peers in specified model
    #[pallet::storage] // model_uid --> peer_data
    pub type TotalModelDelegateStakeBalance<T: Config> = StorageMap<
        _,
        Blake2_128Concat,
        u32,
        u128,
    ...
    #[pallet::storage]
    pub type MaxDelegateStakeBalance<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultMaxDelegateStakeBalance<T>
    >;

    #[pallet::storage]
    pub type MinDelegateStakeBalance<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultMinDelegateStakeBalance<T>
    >;
    ...
    // *NOT IMPLEMENTED
    #[pallet::storage] // ( tx_rate_limit )
    pub type ConsensusTxRateLimit<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultConsensusTxRateLimit<T>
    >;

    // *NOT IMPLEMENTED
    #[pallet::storage] // key --> last_block
    pub type LastConsensusTxBlock<T: Config> = StorageMap<
        _,
        Identity,
        T::AccountId,
        u64,
        ValueQuery,
        DefaultLastConsensusTxBlock<T>
    >;
    ...
    #[pallet::storage]
    pub type ModelsInConsensus<T> = StorageValue<
        _,
        Vec<u32>,
        ValueQuery,
        DefaultModelsInConsensus<T>
    >;
    ...
    #[pallet::storage]
    pub type ModelConsecutiveEpochsThreshold<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultModelConsecutiveEpochsThreshold<T>
    >;
    ...
    #[pallet::storage]
    pub type MaxModelConsensusEpochsErrors<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultMaxModelConsensusEpochsErrors<T>
    >;
    ...
    // *NOT IMPLEMENTED YET
    #[pallet::storage]
    pub type MaxModelResponseErrors<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultMaxZeroConsensusEpochs<T>
    >;
    ...
    pub type ModelResponseErrors<T: Config> = StorageMap<_, Blake2_128Concat, u32, u32, ValueQuery>;

    // The max errors from expected return values when calling a model through a model peer's server
    // *NOT IMPLEMENTED YET
    #[pallet::storage]
    pub type MaxAccountResponseErrors<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultMaxZeroConsensusEpochs<T>
    ...
    #[pallet::storage]
    pub type ModelConsensusUnconfirmedThreshold<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultModelConsensusUnconfirmedThreshold<T>
    >;
    ...
    #[pallet::storage]
    pub type MaxModelConsensusUnconfirmedConsecutiveEpochs<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultMaxModelConsensusUnconfirmedConsecutiveEpochs<T>
    >;
    ...
    pub type MinRequiredModelConsensusSubmitEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredModelConsensusSubmitEpochs<T>
    >;
    ...
    pub type MinRequiredPeerConsensusSubmitEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredPeerConsensusSubmitEpochs<T>
    >;
    ...
    pub type MinRequiredPeerConsensusInclusionEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredPeerConsensusInclusionEpochs<T>
    >;

    // Epochs required to be able to propose and vote on model peer dishonesty
    #[pallet::storage]
    pub type MinRequiredPeerConsensusDishonestyEpochs<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultMinRequiredPeerConsensusDishonestyEpochs<T>
    >;
    ...
    pub type DishonestyVotingPeriod<T> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultDishonestyVotingPeriod<T>
    >;
    ...
    #[pallet::storage]
    pub type MaximumOutlierDeltaPercent<T> = StorageValue<
        _,
        u8,
        ValueQuery,
        DefaultMaximumOutlierDeltaPercent<T>
    >;

    // Maximum model peer penalty count
    #[pallet::storage]
    pub type MaxAccountPenaltyCount<T> = StorageValue<
        _,
        u32,
        ValueQuery,
        DefaultMaxAccountPenaltyCount<T>
    >;
    ...
    pub type ModelPeerConsensusSubmitPercentRequirement<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultModelPeerConsensusSubmitPercentRequirement<T>
    >;

    // Blocks per consensus form
    #[pallet::storage]
    pub type ConsensusBlocksInterval<T: Config> = StorageValue<
        _,
        u64,
        ValueQuery,
        DefaultConsensusBlocksInterval<T>
    >;
    ...
    #[pallet::storage]
    pub type PeerRemovalThreshold<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultPeerRemovalThreshold<T>
    >;
    ...
    #[pallet::storage]
    pub type PeerAgainstConsensusRemovalThreshold<T: Config> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultPeerAgainstConsensusRemovalThreshold<T>
    >;
    ...
    pub type MaxModelRewardsWeight<T> = StorageValue<
        _,
        u128,
        ValueQuery,
        DefaultMaxModelRewardsWeight<T>
    >;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn submit_consensus_data(
            ...
            ensure!(Self::is_account_eligible(account_id.clone()), Error::<T>::AccountIneligible);
            ...
            // Ensure model exists
            ensure!(ModelsData::<T>::contains_key(model_id.clone()), Error::<T>::ModelNotExist);
            ...
            let peer_consensus_epoch_submitted = PeerConsensusEpochSubmitted::<T>::get(
                model_id.clone(),
                account_id.clone()
            );
            // Ensure peer hasn't sent consensus data already
            ensure!(!peer_consensus_epoch_submitted, Error::<T>::ConsensusDataAlreadySubmitted);
            ...
            let min_required_model_consensus_submit_epochs =
                MinRequiredModelConsensusSubmitEpochs::<T>::get();
            ...
            let min_required_peer_consensus_submit_epochs: u64 =
            ...
            ensure!(total_submittable_model_peers >= min_model_peers, Error::<T>::ModelPeersMin);
            ...
            let min_required_consensus_inclusion_epochs =
            ...
            for model_peer in ModelPeersData::<T>::iter_prefix_values(model_id.clone()) {
                ...
                let account_eligible: bool = Self::is_account_eligible(
            ...
            let peer_consensus_epoch_unconfirmed = PeerConsensusEpochUnconfirmed::<T>::get(
                model_id.clone(),
                account_id.clone()
            );
            ...
            if !peer_consensus_epoch_unconfirmed {
                ModelTotalConsensusSubmits::<T>::mutate(model_id.clone(), |n: &mut u32| {
                    *n += 1;
                });
            }

            ModelConsensusEpochSubmitCount::<T>::mutate(model_id.clone(), |n: &mut u32| {
                *n += 1;
            });
            ...
            Self::deposit_event(
                Event::ConsensusDataSubmitted(model_id.clone(), account_id.clone(), consensus_data)
            );
        ...
        pub fn unconfirm_consensus_data(
            ...
            //
            let peer_consensus_epoch_confirm = PeerConsensusEpochUnconfirmed::<T>::get(
                model_id.clone(),
                account_id.clone()
            );
            // Ensure peer hasn't sent consensus data unconfirm already
            ensure!(!peer_consensus_epoch_confirm, Error::<T>::ConsensusDataAlreadyUnconfirmed);
            ...
            ModelConsensusEpochUnconfirmedCount::<T>::mutate(model_id.clone(), |n: &mut u32| {
                *n += 1;
            });
            ...
            Self::deposit_event(
                Event::ConsensusDataUnconfirmed(model_id.clone(), account_id.clone())
            );
        ...
        // #[pallet::weight({0})]
        pub fn add_model(origin: OriginFor<T>, model_path: Vec<u8>) -> DispatchResult {
            let account_id: T::AccountId = ensure_signed(origin)?;

            // Ensure path is unique
            ensure!(!ModelPaths::<T>::contains_key(model_path.clone()), Error::<T>::ModelExist);
            ...
            ensure!(activated, Error::<T>::ModelNotVotedIn);
            ...
            ensure!(total_models < max_models, Error::<T>::MaxModels);
            ...
            if model_fee > 0 {
                ...
                StakeVaultBalance::<T>::mutate(|n: &mut u128| {
                    *n += model_fee;
                });
            }
        ...
        #[pallet::weight({ 0 })]
        pub fn remove_model(origin: OriginFor<T>, model_id: u32) -> DispatchResult {
            let account_id: T::AccountId = ensure_signed(origin)?;
            ...
            let too_many_max_consensus_epochs: bool =
                zero_consensus_epochs > max_zero_consensus_epochs;
            ...
            if total_model_peers < min_model_peers {
                ...
                let model_peers_initialization_epochs: u64 =
                    ModelPeersInitializationEpochs::<T>::get();
            ...
            let _ = ModelPeerConsecutiveConsensusSent::<T>::clear_prefix(
                model_id.clone(),
                u32::MAX,
                None
            );
            let _ = ModelPeerConsecutiveConsensusNotSent::<T>::clear_prefix(
                model_id.clone(),
                u32::MAX,
                None
            );
        ...
        pub fn add_model_peer(
            ...
            ensure!(total_model_peers < max_model_peers, Error::<T>::ModelPeersMax);
            ...
            let peer_exists: bool = match
                ModelPeerAccount::<T>::try_get(model_id.clone(), peer_id.clone())
            {
                Ok(_) => true,
                Err(()) => false,
            };

            ensure!(!peer_exists, Error::<T>::PeerIdExist);

            // Validate peer_id
            ensure!(Self::validate_peer_id(peer_id.clone()), Error::<T>::InvalidPeerId);

            // Validate IP Address
            ensure!(Self::validate_ip_address(ip.clone()), Error::<T>::InvalidIpAddress);
            ...
            Self::deposit_event(Event::ModelPeerAdded {
                model_id: model_id.clone(),
                account_id: account_id.clone(),
                peer_id: peer_id.clone(),
                block: block,
        ...
        pub fn update_model_peer(
            ...
            Self::deposit_event(Event::ModelPeerUpdated {
                model_id: model_id.clone(),
                account_id: account_id.clone(),
                peer_id: peer_id.clone(),
                block: block,
        ...
        pub fn remove_account_model_peers(
            ...
            ensure!(!Self::is_account_eligible(account_id.clone()), Error::<T>::AccountEligible);
        ...
        pub fn update_port(origin: OriginFor<T>, model_id: u32, port: u16) -> DispatchResult {
            let account_id: T::AccountId = ensure_signed(origin.clone())?;
        ...
        pub fn add_to_stake(
            ...
            Self::do_add_stake(origin, model_id, account_id.clone(), stake_to_be_added)
        }
        ...
        pub fn remove_stake(
            ...
            let model_accounts: BTreeMap<T::AccountId, u64> = ModelAccount::<T>::get(
                model_id.clone()
            );
            ...
            ensure!(has_model_account, Error::<T>::ModelPeerNotExist);
            ...
            let is_peer: bool = match
                ModelPeersData::<T>::try_get(model_id.clone(), account_id.clone())
            {
                Ok(_) => true,
                Err(()) => false,
            };
        ...
        pub fn add_to_delegate_stake(
            ...
            Self::do_add_delegate_stake(origin, model_id, account_id.clone(), stake_to_be_added)
        }
        ...
        pub fn propose_model_peer_dishonest(
            ...
            let block: u64 = Self::get_current_block_as_u64();
            let consensus_blocks_interval: u64 = ConsensusBlocksInterval::<T>::get();
            let min_required_peer_consensus_dishonesty_epochs: u64 =
                MinRequiredPeerConsensusDishonestyEpochs::<T>::get();
            ...
            let model_peer_account: (bool, T::AccountId) = match
                ModelPeerAccount::<T>::try_get(model_id.clone(), peer_id.clone())
            {
            ...
            ensure!(model_peer_account.0, Error::<T>::PeerIdNotExist);
            ...
            let min_model_peers: u32 = MinModelPeers::<T>::get();
            ensure!(total_voting_model_peers >= min_model_peers, Error::<T>::ModelPeersMin);

            // --- Ensure voting not already started
            let dishonesty_vote_start_block: u64 = match
                ModelPeerDishonestyVote::<T>::try_get(
                    model_id.clone(),
            ...
            ensure!(block > max_block, Error::<T>::DishonestyVotePeriodCompleted);
            ...
            Self::deposit_event(Event::DishonestModelPeerProposed {
                model_id: model_id.clone(),
                account_id: account_id.clone(),
                block: block,
            });
        ...
        pub fn vote_model_peer_dishonest(
            ...
            // --- Ensure dishonesty proposal exists
                ...
                ModelPeerDishonestyVote::<T>::contains_key(
                    model_id.clone(),
                    model_peer_account.clone().1
                ),
            ...
            ensure!(start_block != 0 && max_block > block, Error::<T>::DishonestyVotingPeriodOver);

            // --- Ensure caller hasn't voted already
            let votes: Vec<T::AccountId> = model_peer_dishonesty_vote.votes;
            ensure!(!votes.contains(&account_id.clone()), Error::<T>::DishonestyVotingDuplicate);
            ...
            if removal_consensus_percentage > peer_removal_threshold {
                ...
                ModelPeerDishonestyVote::<T>::remove(
                    model_id.clone(),
                    model_peer_account.clone().1
                );

                Self::deposit_event(Event::DishonestAccountRemoved {
                    model_id: model_id.clone(),
            ...
            Self::deposit_event(Event::DishonestModelPeerVote {
                model_id: model_id.clone(),
                account_id: model_peer_account.clone().1,
    ...
    impl<T: Config> Hooks<BlockNumberFor<T>> for Pallet<T> {
        fn on_initialize(block_number: BlockNumberFor<T>) -> Weight {
            ...
            if
                block - 1 >= consensus_blocks_interval &&
                (block - 1) % consensus_blocks_interval == 0
            {
            ...
            return Weight::from_parts(8_054_000, 1638).saturating_add(
    ...
    impl<T: Config> BuildGenesisConfig for GenesisConfig<T> {
        fn build(&self) {
            let min_required_model_consensus_submit_epochs: u64 =
                MinRequiredModelConsensusSubmitEpochs::<T>::get();
            let min_required_peer_consensus_submit_epochs: u64 =
                MinRequiredPeerConsensusSubmitEpochs::<T>::get();
            let min_required_peer_consensus_inclusion_epochs: u64 =
                MinRequiredPeerConsensusInclusionEpochs::<T>::get();
            let min_required_peer_consensus_dishonesty_epochs: u64 =
                MinRequiredPeerConsensusDishonestyEpochs::<T>::get();

            let requirement_one: bool =
                min_required_model_consensus_submit_epochs >
                min_required_peer_consensus_submit_epochs;
            let requirement_two: bool =
                min_required_peer_consensus_submit_epochs >
                min_required_peer_consensus_inclusion_epochs;
            let requirement_three: bool =
                min_required_peer_consensus_dishonesty_epochs >=
                min_required_peer_consensus_submit_epochs;
            ...
            if !requirement_one || !requirement_two || !requirement_three {
                ...
                if !requirement_one {
                    log::error!(
                        "MinRequiredModelConsensusSubmitEpochs is not greater than MinRequiredPeerConsensusSubmitEpochs"
                    );
                }
                if !requirement_two {
                    log::error!(
                        "MinRequiredPeerConsensusSubmitEpochs is not greater than MinRequiredPeerConsensusInclusionEpochs"
                    );
                }
                if !requirement_three {
                    log::error!(
                        "MinRequiredPeerConsensusDishonestyEpochs is not greater than or equal to MinRequiredPeerConsensusSubmitEpochs"
                    );
                }
            }
...
impl<T: Config, AccountId> ModelVote<AccountId> for Pallet<T> {
    ...
    fn get_model_path_exist(path: Vec<u8>) -> bool {
        if ModelPaths::<T>::contains_key(path) { true } else { false }
    }
    ...
    fn get_model_id_exist(id: u32) -> bool {
        if ModelsData::<T>::contains_key(id) { true } else { false }
    }
