...
// ./target/release/hypertensor-node benchmark pallet --chain=dev --steps=50 --repeat=20 --pallet=pallet_network --extrinsic=* --wasm-execution=compiled --heap-pages=4096 --output=pallets/network/src/weights.rs --template=./.maintain/frame-weight-template.hbs
